...
Message.commands = {
    ...
    //For photto
    REQUEST_SEND_PHOTO              : 0x0800, // sent by tracker
    ACCEPT_SEND_PHOTO               : 0x8801,
    UPLOAD_PACKAGE_PHOTO            : 0x9988, // sent by tracker
    CONFIRM_UPLOADED_PHOTO          : 0x0f80,
    REQUEST_RESEND_PHOTO            : 0x8800,
    PROTOCOL_LOCATION               : 0x9977,
    GET_PHOTO                       ; 0x4151
...
Message.createFromBuffer = function(buffer, mode) {
    ...
    // if (checksum !== crc.crc16ccitt(binary).toString(16)) {
    //     console.log("checksum error");
    //     console.log(hex);
    //     console.log(checksum);
    //     console.log(crc.crc16ccitt(binary).toString(16));
    //     console.log(hex.substring(0, hex.length - 8));      
    //     return false;
    // }
...
Message.resolveCommand = function(code) {
    ...
    case Message.commands.REQUEST_SEND_PHOTO:
	return Message.commands.ACCEPT_SEND_PHOTO;
...
Message.parseCommandResult = function(code, buffer) {
    ...
    case Message.commands.GET_PHOTO:
	return {
	    "success" : "maybe"
	};
...
Message.prototype.toBuffer = function() {
    ...
    result +=crc.crc16ccitt(new Buffer(result, 'hex')).toString(16)
        + new Buffer('\r\n').toString('hex');
