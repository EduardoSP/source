...
rutaArchivoJournal      = settings.RUTA_CARPETA_ENCENDIDO_APAGADO+'dataJournal'
rutaArchivoJournalCopia = settings.RUTA_CARPETA_ENCENDIDO_APAGADO+'dataJournalCopia' 
