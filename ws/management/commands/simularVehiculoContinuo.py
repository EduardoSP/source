...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--idVehiculo', type=str, help=u"Codigo del vehículo")
    ...
    def handle(self, *args, **options):
        ...
        ping              = 3
	fechaHoraInicial = "2017-02-02T09:47:09"
        fechaHoraFinal   = "2017-02-29T09:49:00"
        
        while fechaHoraInicial < fechaHoraFinal:
            fechaHoraInicial = generarRuta(archivo1, True,  idVehiculo, fechaHoraInicial , ping)
            fechaHoraInicial = generarRuta(archivo2, False, idVehiculo, fechaHoraInicial , ping )
            fechaHoraInicial = generarRuta(archivo2, True,  idVehiculo, fechaHoraInicial , ping)
            fechaHoraInicial = generarRuta(archivo3, False, idVehiculo, fechaHoraInicial , ping)
            fechaHoraInicial = generarRuta(archivo3, True,  idVehiculo, fechaHoraInicial , ping )
            fechaHoraInicial = generarRuta(archivo1, False, idVehiculo, fechaHoraInicial , ping )
            




def generarRuta(archivo, reversar, idVehiculo, fechaHoraInicial, ping):
        print "holamundo"
        fechaResultado = fechaHoraInicial
        ...
        print "Before fail"
        fechaHoraInicial = dateutil.parser.parse(fechaHoraInicial )
        ...
        notificarSegundos = int( float(ping) * 60.0)
        ...
        for i in iterador:
            ...
            if pos.get("tipoPaso","") == "avance":
                ...
                print "VelocidadMS {}".format(velocidadMS)
        ...
        for paso in simulacion:
            ...
            if paso["hacerPing"]:
                ...
                #time.sleep(1)
        print "Retornando: {}".format(fechaResultado)
