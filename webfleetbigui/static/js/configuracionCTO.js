...
<<<<<<< HEAD:webfleetbigui/static/js/configuracion.js
var wsbase     = "http://52.55.0.240/ws"; //Raiz de los servicios web.
var guibase    = "http://52.55.0.240/webfleetbigui"; //Raiz de los servicios web.

=======
var wsbase     = "http://localhost/ws"; //Raiz de los servicios web.
var guibase    = "http://localhost/webfleetbigui"; //Raiz de los servicios web.
var notierbase = "http://localhost:3000";
>>>>>>> origin/master:webfleetbigui/static/js/configuracionCTO.js
